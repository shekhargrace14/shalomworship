        ...
        >
          ...
          <div className=" flex items-center gap-4 w-full ">
            <div className="w-3/12 md:w-2/12 sm:mb-0 mb-2 rounded-lg overflow-hidden  bg-card ">
              <Image src={data?.image || 'https://drive.google.com/uc?export=view&id=19Vm_Qd_6F_ehN5SE2jkUYpnk7TMNwM1g'} alt={data?.title || 'Artist Image'} width={150} height={100} className="bg-card object-cover h-auto w-full" priority={true} />
            </div>
