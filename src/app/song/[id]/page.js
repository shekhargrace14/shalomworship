      ...
      <div>
        <div className="bg-[#1f1f1f] rounded-lg">
          <div className=" lg:container mx-auto  p-4 md:flex gap-4 text-white ">
            <div className="bg-yellow-300 flex items-center md:w-4/12 rounded-lg overflow-hidden sm:lg-0 md:mb-0 mb-4 ">
              <Image
                src={item.image}
            ...
            <div className="md:w-8/12 grid">
              <h1 className="line-clamp-1 md:text-6xl md:mt-12 mb-2 text-4xl font-semibold">
                {item.title}
              </h1>
