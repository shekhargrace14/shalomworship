        ...
        <div className='relative flex flex-col bg-input/30 px-3 py-2 my-2 rounded-md'>
            <section className='flex flex-col gap-4 mb-4 py-4'>
                ...
                <section className='flex gap-2'>
                    <Badge> <NotebookText /> {theSetlist.songs.length} song</Badge>
                    <Badge> <CalendarDays /> {new Date(theSetlist.createdAt).toLocaleDateString()}</Badge>
                </section>
            </section>
                    ...
                    <DialogContent>
                        <DialogHeader>
                            <p className='text-left'>
                                This will <strong className="text-destructive">remove</strong> all songs
                                from <strong className="text-destructive">"{theSetlist.name}"</strong> setlist permanently.
                            </p>
                        </DialogHeader>
