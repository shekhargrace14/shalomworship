...
export default function SongCard({
  ...
  return (
    <Link href={`/song/${slug}-${id}`} className="block">
      <Card
        className={cn(
          "group overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg gap-0 bg-transparent border-none hover:bg-card p-2",
          variant === "imageLeft" && "flex flex-row",
