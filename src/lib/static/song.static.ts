import { albumFullSelect, channelFullSelect, categoryBasicSelect, categoryFullSelect, songBaseSelect, songContentSelect, songFullSelect, songMediaSelect, channelBaseSelect } from '@/prisma/selectors';
